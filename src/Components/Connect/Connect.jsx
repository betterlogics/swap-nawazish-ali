...
function Connect(props) {
  ...
  return (
    ...
    >
      ...
      <Modal.Footer className='m_footer'>
         
         <p>Haven’t got a crypto wallet yet?</p> <br/>
        <Button className='btn_modall'>Learn how to connect</Button> 
      </Modal.Footer>
    </Modal>
    </div>
  )
